...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-900">
      <section className="gradient-hero border-b border-sky-100">
        <div className="max-w-7xl mx-auto px-6 py-6 md:px-10">
          ...
          <div className="grid gap-12 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
            <div>
              <p className="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-sm text-sky-700 border border-sky-100">
                <ShieldCheck className="w-4 h-4" />
                Designed for chama groups and member trust
              </p>
              <h1 className="mt-6 text-5xl md:text-6xl font-semibold leading-tight tracking-tight text-slate-950">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[36px] bg-white border border-sky-100 p-6 card-shadow-lg">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {highlights.map(item => {
            ...
            return (
              <div
                key={item.title}
                className="rounded-[30px] bg-white border border-border p-7 card-shadow hover-lift"
              >
      ...
      <section className="max-w-7xl mx-auto px-6 py-2 pb-16 md:px-10">
        <div className="rounded-[36px] bg-white border border-border p-8 md:p-10 card-shadow">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            <div className="rounded-[28px] gradient-accent-soft border border-sky-100 p-6">
            ...
            <div className="rounded-[28px] bg-blue-50 p-6 border border-blue-100">
              <div className="w-12 h-12 rounded-2xl bg-white text-blue-700 flex items-center justify-center shadow-sm">
        ...
        <div className="rounded-[36px] bg-slate-900 text-white p-8 md:p-10">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <Link to={isAuthenticated ? "/app/dashboard" : "/login"}>
              <Button
                size="lg"
                className="rounded-full bg-white text-slate-900 hover:bg-white/90 px-6"
              >
                Enter the workspace
              </Button>
            </Link>
